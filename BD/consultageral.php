...
$executa =" select * from agenda where AgeStatus NOT IN ('Apagada','Realizada','Cancelada') order by AgeData";
...
<table style='background-color:white; margin:5%; margin-bottom: 40px;' border="1">
  <tr style="background-color: #cecece;">
   <th style="font-size: 20px;">Nº da Anotação</th>
   <th style="font-size: 20px;" colspan="2">Data de Termino</th>
   <th style="font-size: 20px;" colspan="2">Tarefa Em Aberto</th>
	 <th style="font-size: 20px;" >Status</th>
   <th style="font-size: 20px;" >Alterar</th>
   <th style="font-size: 20px;" >Excluir</th>
  </tr>
...
echo"<form align='center' action='inicio.php'>";
  echo  "<input style='margin-top:10px; margin-right: 120px;' type='submit' value='Página Inicial' />";
    echo  "<input style='margin-top:10px; margin-bottom: 60px;' onclick=location.href='consultarealizada.php';  type='button' value='Tarefas Realizadas' />";
echo"</form>";
